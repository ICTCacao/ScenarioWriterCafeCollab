...
// ------------------------------------------------------------------------------
	//ﾃﾞﾌｫﾙﾄｱｸｼｮﾝ
	$ThisPHP = 'swScenarioEditScene.php';
	//ﾃﾞｰﾀ管理ｸﾗｽ
...
END_OF_HTML;
	...
	swMenuBar_Print('./include/swEditDropDownMenu.php', 'frmSwScenario', swFunc_SanitizeStrings($fdtScenarioTitle), array(
		array('label'=>'場面追加', 'onclick'=>"fncNewSceneInit(frmSwScenario);"),
	), $fdtUserName);
	print <<<END_OF_HTML
				...
				<div class="row">
					<div class="col-sm-12">
						<form class="" role="form" name="frmSwScenario" id="frmSwScenario" method="POST" action="">
							...
							<input type="hidden" name="SelectSceneId" id="SelectSceneId" value="">
							<input type="hidden" name="listpos" id="listpos" value="">
							
							<!-- データ表示位置 -->
			
								<span id="SceneList"></span>
	...
	<script type="text/javascript" src="./ajax/ajaxSwScenarioEditScene.js"></script>
	<script language="JavaScript">
		fncReadSwSceneList(frmSwScenario)
	</script>
