...
- マニュアルは標準版・コラボ版で **同じ 1 冊**（本人指示 2026-09-21）。docs/manual.md / manual-slides.md / manual.pdf はコラボ版だけの機能に【コラボ版】を付けて両方に通じる書き方にした。標準版リポジトリへの反映は本人が判断（単独版フォルダには触らない約束）。
- コラボ制作画面のスクリーンショット（docs/img/）は未撮影。マニュアル本文は画像なしで書いてある。
