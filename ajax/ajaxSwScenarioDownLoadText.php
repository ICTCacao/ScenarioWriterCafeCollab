...
//     シナリオテキストダウンロード
//
//     ajaxSwScenarioDownLoadText.php
// -----------------------------------------------------------
// ------------------------------------------------------------------------------
	//定数読み込み
...
$scenario = '';
$scenario .= '　　　　　　　　　　ここから始まり。'."\n";
$scenario .= 'いちろう　　　　　「いちろうの台詞。」'."\n";
$scenario .= 'いちろう　　　　　「いちろうの台詞。」'."\n";
$scenario .= 'いちろう　　　　　「いちろうの台詞。」'."\n";
$scenario .= 'いちろう　　　　　「いちろうの台詞。」'."\n";
// 出力
$fileName = "pref_" . date("YmdHis") . ".txt";
...
function fncScenarioRead($mySqlConnObj,$ScenarioId,$LoginId){
	...
	$retHtml = <<<END_OF_HTML
		...
		<div class="" id="Scenelio">
			<div class="col-sm-12">
				<h3>$ScenarioTitle &nbsp; $ScenarioSubtitle</h3>
...
function fncArrangeScenarioLine($mySqlConnObj,$ScenarioLinesId,$ScenarioType,$CharacterId,$ScenarioLines,$ScenarioLinesOrderNo){
	...
	//ﾌﾟﾛﾊﾟﾃｨGet
	$fdtCharacterName = swFunc_SanitizeStrings($clsSwCharacter->clsSwCharacterGetCharacterName());      //登場人物名
	//サニタイズ
...
END_OF_HTML;
	...
	if(isset($UserOptionStyleArray[$ScenarioType])){
		...
		//CSS編集
		$cssCharacterName = 'style="line-height: 1.8em;font-size: '.$UserOptionStyleFontSize.'px;text-align: '.$align.';"';
		$cssScenarioLines = 'style="line-height: 1.8em;font-size: '.$UserOptionStyleFontSize.'px;color: '.$UserOptionStyleColor.';padding-left: '.$UserOptionStyleIndent.'em;"';
				$retHtml .= <<<END_OF_HTML
							
							<li class="col-sm-2">&nbsp;</li>
							<li class="col-sm-2" $cssCharacterName>$fdtCharacterName</li>
							<li class="col-sm-7" $cssScenarioLines>$ScenarioLines</li>
